...
class SecurityConfig @Autowired constructor(
    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain {
        ...
        return http
            ...
            .antMatchers("/skin_condition_logs/*","/survey_logs/*").authenticated()
            .antMatchers("/user").permitAll()
            .antMatchers("/user/all/usernames").permitAll()
            .antMatchers("/user/medicines/*", "/user/diseases/*", "user/me/*").hasRole("")
            .and()
            .httpBasic()
